...
<script type="text/javascript" src="http://down.baiduwebgame.com/danaotiangong/131/js/swfobject.js"></script>
...
<script type="text/javascript">
    ...
    var flashvars =
	{
		...
		server: '7',
		gameid: '',
		clientip:'210.16.188.138',
		create_flag:'0',
		create_logurl:escape('http://gy.670wan.com')	};
...
<script type="text/javascript" src="/SWF.js"></script></head>
</head>
