/// <reference path="jquery.min.js"/*tpa=http://www.pz1g.com/js/jquery.min.js*/ />
//Register
$(function () {
...
function ckPas() {
    ...
    if (uPas.length < 6 || uPas.length > 16) {
        return false;
    }
    return true;
}
function ckPas1() {
    ...
    if (uPas1.length < 6 || uPas1.length > 16) {
        return false;
    }
    return true;
}
...
function ckOldPas() {
    ...
    if (oPas.length < 6 || oPas.length > 16) {
        return false;
    }
    return true;
}
...
function focusNameStyle() {
    ...
    $("#u_name").next("em").removeClass().addClass("on").html("• 长度为4-16字符 (1个汉字等于2字符)");
}
...
function focusSCodeStyle() {
    ...
    $("#s_code").next("em").removeClass().addClass("on").html("• 请输入您补填邮箱是系统产生的安全码");
}

function blurSCodeStyle() {
    if (!ckSafeCode()) {
        $("#s_code").parent("span.at_text").removeClass("t_1_i").addClass("t_1_e");
        $("#s_code").next("em").removeClass().addClass("orr").html("<u class=\"at_msg m_3_e\"></u>请输入正确的安全码。");
        return false;
    } else {
        $("#s_code").parent("span.at_text").removeClass("t_1_i t_1_e").addClass("t_1_o");
        $("#s_code").next("em").removeClass().html("<u class=\"at_msg m_3_o\"></u>");
        return true;
    }
}
