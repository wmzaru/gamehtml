...
if(isset($_GET["s"]))
{
	 ...
	 if(!isset($_GET["roleid"]))
	 {
	    ...
	    $roleidinfo=mysql_query("SELECT * FROM roleid where namemd5id='".$GLOBALS["gnamemd5id"]."'");
...
//判断资源
if(ConnectMysqlServer_NO_err($s)==0)
{
  exit;
}

$user_role_row = mysql_fetch_array(mysql_query("SELECT * FROM user_role WHERE user_id='".$roleid."'"));
if($user_role_row["level"]>20)
{
     $res="http://down.baiduwebgame.com/danaotiangong/130/";
}
